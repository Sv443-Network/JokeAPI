...
class SubmissionEndpoint extends Endpoint
{
     ...
     * @abstract Abstract method - Override this, else a MissingImplementationError is thrown!
     ...
     * @param {string|null} data The raw request body as a string or `null` if no body was provided
