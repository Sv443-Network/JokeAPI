module.exports = {
    ...
    server: {
        ...
        maxRequestsPerMinute: 25                                       // max requests from one IP address per minute
    },
    jokePath: "./data/jokes.json",                                     // JSON file which contains all jokes
    logPath: "./data/requests.log",                                    // request log file path
    logMaxLines: 400,                                                  // count of lines that will trigger a log deletion
    ...
    IPblacklistPath: "./data/ipBlacklist.json",                        // path to the IP blacklist file
    IPwhitelistPath: "./data/ipWhitelist.json"                         // path to the IP whitelist file
}