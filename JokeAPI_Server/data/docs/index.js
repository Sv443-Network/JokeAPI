            ...
            xh2.onreadystatechange = () => {
                if(xh2.readyState == 4 && xh2.status == 200) {
                    ...
                    let totalJokeCount = JSON.parse(xh2.responseText).jokes.totalCount;

                    gebid("insertTotalJokeCount").innerHTML=totalJokeCount.toString();
